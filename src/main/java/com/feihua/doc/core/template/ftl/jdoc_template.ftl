...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box;}
    ...
    .pagewelcom { transition: all 0.5s; min-height: calc(100vh - 86px);}
    .info { padding-top: 65px; padding-left: 50px;}
    .pageitem .commet, .pageitem .return, .pagewelcom { padding: 10px; background-color: #fff;}
    ...
    .pageitem .form { padding-top: 15px; padding-right: 45px; padding-bottom: 15px;}
    .form-group { overflow: hidden; margin-bottom: 15px;}
    .control-label { float: left; width: 16.66666667%; padding-top: 7px; margin-bottom: 0; text-align: right; font-weight: 700; padding-right: 15px;}
    .inputbox { margin-left: 16.66666667%; padding-left: 15px; padding-right: 15px;}
  ...
  <script id="sidenav-temp" type="text/html">
    ...
    <div class="page-wrapper row">
      <div class="pagewelcom">
        <h2>欢迎使用JDoc</h2>
        <h4 class="info">前端模板作者：周星华（QQ：499244819）</h4>
        <h4 class="info">后端模板作者：梁豪（QQ：451671299）</h4>
        <h4 class="info">QQ交流群：232558246</h4>
       </div>
            ...
            <div class="form-group">
              ...
              <div class="inputbox">
                <div class="radio-inline">
                  <label>
                    <input type="radio" checked="checked" value="post" name="type-{{$value.url}}"> post
                  </label>
                </div>
                <div class="radio-inline">
                  <label>
                    <input type="radio" value="get" name="type-{{$value.url}}"> get
                  </label>
                </div>
              </div>
            </div>
      ...
      $.each(json.split("\r\n"), function (index, node) {
        ...
        if (subcode[1]) {
          if (subcode[1].match(/\{$/) || subcode[1].match(/\[$/)) {
            ...
            codekey += ":<span class=\"codeval\">" + subcode[1] + "</span>";
          }
        }
